        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0">Ajouter un type de transaction</h3>
                </div>
                    ...
                    <form method="POST" action="{{ route('transaction-types.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_credit') is-invalid @enderror"
                                ...
                                <option value="0" {{ old('is_credit') == 0 ? 'selected' : '' }}>Débit</option>
                                <option value="1" {{ old('is_credit') == 1 ? 'selected' : '' }}>Crédit</option>
                            </select>
                            @error('is_credit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
